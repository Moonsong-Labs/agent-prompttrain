...
| request_type                | VARCHAR(50)  | Type: inference, query_evaluation, quota, or internal_operation |
...
- `internal_operation` - Claude Code CLI internal requests (e.g., file path extraction) - **not stored in database**
